...
namespace MVC.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Nombre,Password")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Nombre,Password")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
